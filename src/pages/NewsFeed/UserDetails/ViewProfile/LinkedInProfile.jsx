  ...
  return (
    <>
      <div className="flex justify-between gap-5">
          ...
          <div className="rounded-lg mb-4">
            ...
            <div className="p-2 ">
              ...
              <div>
                ...
                <div className="font-[Poppins] flex gap-4 lg:gap-8 px-2 py-2 pb-2 border-b-2 shadow-2xl ">
        ...
        <div
          className={`${theme === 'dark' ? 'bg-[#003049]' :
            theme === 'night' ? 'bg-[#03071e]' :
              theme === 'light' ? 'bg-[#f0efeb]' : ''} md:w-4/12  hidden md:block  border-[#8f9090] border   rounded-2xl p-4 mb-6 `}>
          ...
          <div className="">
            ...
            <div className="mt-5 p-3 rounded-lg shadow-lg">
              ...
              <Link to="/blog-feed">
                {" "}
                <button className={`${theme === 'light' ? 'text-white bg-gradient-to-bl from-[#006466] to-[#212f45] hover:bg-gradient-to-tr hover:from-[#006466] hover:to-[#212f45]' :
                  theme === 'dark' ? 'text-white bg-gradient-to-bl from-[#48cae4] to-[#051923] hover:bg-gradient-to-tl hover:from-[#051923] hover:to-[#48cae4]' :
                    theme === 'night' ? 'text-white bg-gradient-to-bl from-[#0d1b2a] to-[#b79ced] hover:bg-gradient-to-tr hover:from-[#0d1b2a] hover:to-[#b79ced]' : ''} transition-all duration-1000 px-4 py-1 font-semibold text-xs mt-2 rounded-lg`}>
                  See More...
                </button>
