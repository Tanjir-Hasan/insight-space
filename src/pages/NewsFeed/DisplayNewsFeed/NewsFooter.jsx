import { FaArrowRight, FaComment, FaEllipsisV, FaHeart } from 'react-icons/fa';
                                ...
                                <div className="flex justify-between">
                                    <div className="flex space-x-2">
                                        ...
                                        <div>
                                            ...
                                            {commentAction === c.commentId && <div><textarea ref={updateRef} name="" id="" cols="80" rows="2" defaultValue={c.comment} className="w-full px-4 py-2 border border-spacing-4 rounded-3xl"></textarea>
