import { FaArrowRight, FaComment, FaEllipsisV } from 'react-icons/fa';
        ...
        <div>
            ...
            <div className='flex items-center space-x-8 p-6'>
                ...
                <div className="w-full flex items-center gap-5">
                    ...
                    <button onClick={() => handleReact(p._id, userDetails.email)} className="flex items-center"><AiFillHeart className={p.react.includes(userDetails.email) ? "text-2xl text-red-600 me-2" : "text-2xl me-2"}></AiFillHeart> {p.react.length}</button>
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <div>
...

                                            {
                                                ...
                                                <div><textarea ref={updateRef} name="" id="" cols="80" rows="2" defaultValue={c.comment} className="w-full px-4 py-2 border border-spacing-4 rounded-3xl"></textarea>

                                                    <button className="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white px-4 py-2 rounded-full transition duration-300 w-full" onClick={() => handleUpdateComment(p._id, c.commentId, updateRef, setIsAction, setCommentAction)}>Update</button>
