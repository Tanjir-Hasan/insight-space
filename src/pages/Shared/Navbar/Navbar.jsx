                    ...
                    <div className='flex gap-3 items-center'>
                        ...
                        <div className='lg:hidden md:block'>
                            ...
                            <span className='duration-1000' onClick={() => setIsOpen(!isOpen)}>
                                {isOpen ? (
                                    <BiMenuAltRight className={`h-8 w-6 cursor-pointer ${theme === 'light' ? 'text-[#3c6e71]' : 'text-[#48cae4]'}`} />
                                ) : (
                                    <BiMenu className={`h-8 w-6 cursor-pointer ${theme === 'light' ? 'text-[#3c6e71]' : 'text-[#48cae4]'}`} />
                                )}
                            </span>
