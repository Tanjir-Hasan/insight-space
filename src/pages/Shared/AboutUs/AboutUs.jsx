                        ...
                        <div className="lg:flex justify-between rounded-lg">
                            ...
                            <div className="relative w-10/12  hidden sm:block py-24">
                                ...
                                <motion.div
                                    ...
                                    className="w-full md:w-5/6 hover:bg-[#84a98c] bg-slate-400  duration-500 rounded-3xl mb-5">
                                    <div className="relative h-40 rounded-lg flex px-5 items-center">
                                        ...
                                        <div className='flex'>
                                            ...
                                            <div>
                                                <p className=" font-[Cinzel] text-justify">Newsfeed for Timely Updates: newsfeed delivers a continuous stream of relevant posts. Users can stay informed about the latest trends,ensuring they remain up-to-date with relevant information within their field of interest.</p>
                                            </div>
                                        </div>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div
                                    ...
                                    className=" w-full md:w-5/6 hover:bg-[#84a98c] bg-slate-400 duration-500 rounded-3xl">
                                    <div className="relative h-40 rounded-lg flex px-5 items-center">
