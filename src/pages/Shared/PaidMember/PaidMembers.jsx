...
const PaidMembers = () => {
    const memberShip = {
        backgroundImage: 'url(https://www.benjamindada.com/content/images/dadabenblog/2020/04/transfer-money-nigeria-sendcash.gif)',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        backgroundSize: 'cover'
    }
    return (
        <div className=' font-[Poppins] mb-96'>
            <div className=''>
                <img className='w-full h-[500px]' src="https://samrack.com/wp-content/uploads/2020/10/Kenya-Mobile-Money-MPESA-PesaLink.gif" alt="" />
                ...
                <div className='w-10/12 mx-auto grid gap-5 lg:grid-cols-3 md:grid-cols-2'>
                    ...
                    <div className=' relative border  bg-lime-50 p-3 px-10 rounded-md  space-y-2  hover:bg-[#d3e4d6] transition duration-1000 ease-in-out transform hover:-translate-y-8'>
                        ...
                        <button className='text-xl text-white font-[Poppins] bg-[#84a98c] hover:bg-[#344e41] w-full duration-700 py-2 rounded-lg'>Get Basic</button>
