...
const PaymentHistory = () => {
  ...
  return (
    ...
    <motion.div
      ...
      <div className={` ${theme === 'dark' ? 'dark text-white' : ''} mt-20 pb-10`}>
        <div onClick={handlePrint} className='text-right relative my-2'>
          <button className='text-xl text-white font-[Poppins] bg-[#3c6e71] hover:bg-[#335c67] px-12 duration-700 py-3 rounded-lg' >Download invoice</button>
          <img className='w-12 h-12 rounded-md absolute right-48 top-0' src="https://cdn.dribbble.com/users/151595/screenshots/3517495/icon_downloading.gif" alt="" />
        </div>
