    ...
    return (
        <div className='mb-28 font-[Poppins]'>
            ...
            <div className='w-8/12 mx-auto'>
                <div className='md:flex items-center gap-5 border mb-5 rounded-md hover:bg-[#d3e4d6] transition duration-1000 ease-in-out'>
                ...
                <div className='md:flex items-center  gap-5 border rounded-md hover:bg-[#d3e4d6] transition duration-1000 ease-in-out'>
                    <div className='md:w-[30%]'>
