    ...
    return (
        <div className={`${theme}`}>
            ...
            <div className='md:w-10/12 w-11/12 mx-auto'>
                <h2 className={`${theme === 'light' ? 'border-[#3c6e71]' : theme === 'dark' ? 'border-[#48cae4]' : theme === 'night' ? 'border-[#b79ced]' : ''} border-b-2 md:text-5xl text-4xl font-[Poppins] lg:w-1/2 w-11/12 mb-8`}>Peer To Peer learning</h2>
            </div>
