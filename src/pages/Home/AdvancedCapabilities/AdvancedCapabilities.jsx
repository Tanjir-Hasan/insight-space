...
const AdvancedCapabilities = () => {
    ...
    return (
        <>
            <div className={`${theme === 'dark' ? 'dark' : ''} pb-16`}>

                <div className="md:w-10/12 w-11/12 mx-auto">

                    <h1 className='text-center md:text-5xl text-4xl font-[Poppins] border-b-2 border-[#84a98c] lg:w-1/2 md:w-10/12 mx-auto lg:pt-20 pt-10'>
                ...
                <div className='lg:flex items-center gap-10 w-10/12 py-10 mx-auto'>
                    ...
                    <div className='w-11/12'>
                        ...
                        <div className='hover:bg-[#84a98c] duration-500 rounded-b-xl p-10'>
                    ...
                    <div className='w-11/12'>
                        ...
                        <div className='p-10 hover:bg-[#84a98c] duration-500 rounded-t-xl'>
