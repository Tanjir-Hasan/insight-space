        ...
        <>
            <div className={`${theme} pb-16`}>
                ...
                <div className="md:w-10/12 w-11/12 mx-auto">
                    ...
                    <h1 className={`${theme === 'light' ? 'border-[#3c6e71]' : theme === 'dark' ? 'border-[#48cae4]' : theme === 'night' ? 'border-[#b79ced]' : ''} border-b-2 text-center md:text-5xl text-4xl font-[Poppins] lg:w-1/2 md:w-10/12 mx-auto lg:pt-20 pt-10`}>
                ...
                <div className='lg:flex items-center gap-10 w-10/12 py-10 mx-auto'>
                    ...
                    <div className='w-11/12'>
                        ...
                        <div className={`${theme === 'light' ? 'hover:bg-[#3c6e71] hover:text-white' : theme === 'dark' ? 'hover:bg-[#051923]' : theme === 'night' ? 'hover:bg-[#0d1b2a]' : ''} duration-1000 rounded-b-xl p-10`}>
