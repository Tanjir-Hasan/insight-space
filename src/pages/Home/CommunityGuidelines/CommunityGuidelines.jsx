                ...
                <motion.div
                    ...
                    <div>
                        <div className="relative group">
                            ...
                            <span className="absolute -bottom-1 w-9/12 left-0 h-0.5 bg-[#3c6e71] transform scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-700"></span>
                        </div>
