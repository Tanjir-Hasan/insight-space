...
const BlogFeedss = () => {
    ...
    return (
        <div
            className={`${theme === 'dark' ? 'dark' : ''} w-10/12 mx-auto `}>
            ...
            <div className='md:flex gap-20'>
                <div
                    className={`${theme === 'dark' ? 'dark' : 'bg-[#f0efeb]'} md:w-8/12 rounded-lg border `}>


                    <div className='border rounded-lg border-[#84a98c]'>
                        <div className="p-4">
                            <div className="flex space-x-2 mb-4">
                                <img src={singleData.userPhoto ? singleData.userPhoto : "https://i.ibb.co/txZTzJB/user-1.png"} alt="user photo" className="w-12 h-12 rounded-full" />
                                <div>
                                    <p className="text-lg font-semibold pt-1">{singleData.userName ? singleData.userName : "User"}</p>
                ...
                <motion.div
                    ...
                    <h2 className=" text-center text-4xl uppercase mb-2 font-bold  font-[Poppins] border-b-2 border-[#84a98c]">Blog heading</h2>
